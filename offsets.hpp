...
namespace cs2_dumper {
    namespace offsets {
        ...
        namespace client_dll {
            constexpr std::ptrdiff_t dwCSGOInput = 0x1E2B690;
            constexpr std::ptrdiff_t dwEntityList = 0x1D04458;
            constexpr std::ptrdiff_t dwGameEntitySystem = 0x1FA5568;
            constexpr std::ptrdiff_t dwGameEntitySystem_highestEntityIndex = 0x20F0;
            constexpr std::ptrdiff_t dwGameRules = 0x1E204C8;
            constexpr std::ptrdiff_t dwGlobalVars = 0x1BD5150;
            constexpr std::ptrdiff_t dwGlowManager = 0x1E1D368;
            constexpr std::ptrdiff_t dwLocalPlayerController = 0x1E0D558;
            constexpr std::ptrdiff_t dwLocalPlayerPawn = 0x1BDFE90;
            constexpr std::ptrdiff_t dwPlantedC4 = 0x1E26930;
            constexpr std::ptrdiff_t dwPrediction = 0x1BDFDC0;
            constexpr std::ptrdiff_t dwSensitivity = 0x1E1DDC8;
            constexpr std::ptrdiff_t dwSensitivity_sensitivity = 0x48;
            constexpr std::ptrdiff_t dwViewAngles = 0x1E2BE40;
            constexpr std::ptrdiff_t dwViewMatrix = 0x1E21230;
            constexpr std::ptrdiff_t dwViewRender = 0x1E22050;
            constexpr std::ptrdiff_t dwWeaponC4 = 0x1DBE940;
        }
        // Module: engine2.dll
