...
namespace cs2_dumper {
    namespace interfaces {
        ...
        namespace client_dll {
            constexpr std::ptrdiff_t ClientToolsInfo_001 = 0x1BD8B20;
            constexpr std::ptrdiff_t EmptyWorldService001_Client = 0x1B93E90;
            constexpr std::ptrdiff_t GameClientExports001 = 0x1BD5800;
            constexpr std::ptrdiff_t LegacyGameUI001 = 0x1BF42C0;
            constexpr std::ptrdiff_t Source2Client002 = 0x1E1B5F0;
            constexpr std::ptrdiff_t Source2ClientConfig001 = 0x1DB54C0;
            constexpr std::ptrdiff_t Source2ClientPrediction001 = 0x1BDFDC0;
            constexpr std::ptrdiff_t Source2ClientUI001 = 0x1BF2750;
        }
        // Module: engine2.dll
        ...
        namespace filesystem_stdio_dll {
            constexpr std::ptrdiff_t VAsyncFileSystem2_001 = 0x215AF0;
            constexpr std::ptrdiff_t VFileSystem017 = 0x2106B8;
        }
        // Module: host.dll
        namespace host_dll {
        ...
        namespace navsystem_dll {
            constexpr std::ptrdiff_t NavSystem001 = 0x11F7C0;
        }
        ...
        namespace panoramauiclient_dll {
            constexpr std::ptrdiff_t PanoramaUIClient001 = 0x290200;
        }
        // Module: particles.dll
        namespace particles_dll {
            constexpr std::ptrdiff_t ParticleSystemMgr003 = 0x586850;
        }
        ...
        namespace resourcesystem_dll {
            constexpr std::ptrdiff_t ResourceSystem013 = 0x7CB40;
        }
        ...
        namespace server_dll {
            constexpr std::ptrdiff_t EmptyWorldService001_Server = 0x16FB8B0;
            constexpr std::ptrdiff_t EntitySubclassUtilsV001 = 0x16A7FB0;
            constexpr std::ptrdiff_t NavGameTest001 = 0x17A2E20;
            constexpr std::ptrdiff_t ServerToolsInfo_001 = 0x1752D78;
            constexpr std::ptrdiff_t Source2GameClients001 = 0x174E730;
            constexpr std::ptrdiff_t Source2GameDirector001 = 0x18AC7C0;
            constexpr std::ptrdiff_t Source2GameEntities001 = 0x1752480;
            constexpr std::ptrdiff_t Source2Server001 = 0x17522E0;
            constexpr std::ptrdiff_t Source2ServerConfig001 = 0x197DBE8;
            constexpr std::ptrdiff_t customnavsystem001 = 0x1687AB8;
        }
        // Module: soundsystem.dll
        namespace soundsystem_dll {
            constexpr std::ptrdiff_t SoundOpSystem001 = 0x3E4420;
            constexpr std::ptrdiff_t SoundOpSystemEdit001 = 0x3E4300;
            constexpr std::ptrdiff_t SoundSystem001 = 0x3E3E30;
            constexpr std::ptrdiff_t VMixEditTool001 = 0x485EC89B;
        }
        // Module: steamaudio.dll
        namespace steamaudio_dll {
            constexpr std::ptrdiff_t SteamAudio001 = 0x2522B0;
        }
        // Module: steamclient64.dll
        namespace steamclient64_dll {
            constexpr std::ptrdiff_t CLIENTENGINE_INTERFACE_VERSION005 = 0xFFFFFFFF8BB1AE0A;
            constexpr std::ptrdiff_t IVALIDATE001 = 0x1549E28;
            constexpr std::ptrdiff_t SteamClient006 = 0x15474F0;
            constexpr std::ptrdiff_t SteamClient007 = 0x15474F8;
            constexpr std::ptrdiff_t SteamClient008 = 0x1547500;
            constexpr std::ptrdiff_t SteamClient009 = 0x1547508;
            constexpr std::ptrdiff_t SteamClient010 = 0x1547510;
            constexpr std::ptrdiff_t SteamClient011 = 0x1547518;
            constexpr std::ptrdiff_t SteamClient012 = 0x1547520;
            constexpr std::ptrdiff_t SteamClient013 = 0x1547528;
            constexpr std::ptrdiff_t SteamClient014 = 0x1547530;
            constexpr std::ptrdiff_t SteamClient015 = 0x1547538;
            constexpr std::ptrdiff_t SteamClient016 = 0x1547540;
            constexpr std::ptrdiff_t SteamClient017 = 0x1547548;
            constexpr std::ptrdiff_t SteamClient018 = 0x1547550;
            constexpr std::ptrdiff_t SteamClient019 = 0x1547558;
            constexpr std::ptrdiff_t SteamClient020 = 0x1547560;
            constexpr std::ptrdiff_t SteamClient021 = 0x1547568;
            constexpr std::ptrdiff_t SteamClient022 = 0x1547570;
            constexpr std::ptrdiff_t p2pvoice002 = 0x14E2FDF;
            constexpr std::ptrdiff_t p2pvoicesingleton002 = 0x15240F0;
        }
        // Module: tier0.dll
        namespace tier0_dll {
        ...
        namespace worldrenderer_dll {
            constexpr std::ptrdiff_t WorldRendererMgr001 = 0x1FECB0;
        }
    }
}
